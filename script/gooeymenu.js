...
var gooeymenu={
	...
	setup:function(usersetting){
		jQuery(function($){ //on document.ready
			...
			var $effectref=$(gooeymenu.effectmarkup).css({top:$menulinks.eq(0).position().top, height:$menulinks.eq().outerHeight()}).appendTo($menu) //add trailing effect LI to the menu UL
